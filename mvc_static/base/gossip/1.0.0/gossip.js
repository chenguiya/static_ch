define("base/gossip/1.0.0/gossip",["jquery","module/slidebox/slidebox"],function($){
	"use strict";
	var b=$("jquery"),c=$("module/slidebox/slidebox"),e={};	
	
	//花边遮罩
	b('.tid_ktag li').hover(function(){
	    b(this).find('.flag_txt').show();
	},function(){
	    b(this).find('.flag_txt').hide();
	});
